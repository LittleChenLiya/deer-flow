...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    formCreateTitle: "新建智能体",
    editPageTitle: "编辑智能体",
    sectionBasic: "基本信息",
    fieldName: "智能体名",
    fieldDescription: "功能描述",
    fieldModel: "选用模型",
    sectionModel: "选用模型",
    soulTitle: "个人设定",
    soulHint: "性格、原则与边界（Markdown）",
    soulGenerate: "AI 生成",
    soulGenerateHint:
      "根据名称、描述和当前文案生成 SOUL 草稿，请核对后再保存。",
    soulGenerating: "生成中…",
    soulGenerateError: "生成 SOUL 失败",
    soulGenerated: "已生成 SOUL，请检查后保存",
    sectionCapability: "能力配置",
    createSuccess: "智能体已创建",
    settingsNamePlaceholder: "字母、数字、连字符，例如 code-reviewer",
    descriptionPlaceholder: "简要说明该智能体的用途",
    modelInherit: "默认模型",
  },
  ...
  settings: {
    ...
    appearance: {
      sectionTitle: "外观",
      sectionDescription: "外观模式、主题颜色与显示语言。",
      appearanceModeTitle: "外观模式",
      appearanceModeDescription: "跟随系统或选择固定的浅色、深色界面。",
      themeColorTitle: "主题颜色",
      themeColorDescription: "选择一种主色，用于按钮、焦点环与强调元素。",
      accents: {
        default: "经典",
        ocean: "海洋蓝",
        forest: "森野绿",
