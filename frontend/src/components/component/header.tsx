...
import { headerActionPlusGlyphClass, headerButtonClass } from "./styles";

/** Bold + before page-header create labels (matches dialog close ×). */
...
/** Outline create action in `PageHeader` (glyph + label). */
...
/** Outline header action with optional leading icon (import / export / …). */
...
export function Header({
  ...
  backHref: string;
  title: string;
  /** Shown inline to the right of the title (e.g. run id). */
  titleMeta?: ReactNode;
